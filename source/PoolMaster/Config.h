...
#define FILTRATION_PUMP 40 //Pompe Piscine
#define PH_PUMP         39 //Pompe PH
#define CHL_PUMP        38 //Pompe Chlore
#define HEAT_ON         45 //Chauffage

#define RELAY_R1   41   //Eclairage Piscine
#define RELAY_R2   43   //Vanne Eau Douche
#define RELAY_R6   42   //Vanne Eau Régulation
#define RELAY_R7   44
#define RELAY_R8   31
#define RELAY_R9   30
...
//MAC Address of DS18b20 Capteur de température Eau
DeviceAddress DS18b20_0 = { 0x28, 0x76, 0x29, 0x94, 0x97, 0x12, 0x03, 0x1D }; //Sonde 28 76 29 94 97 12 03 1D
String sDS18b20_0;
//MAC Address of DS18b20 Capteur de température Exterieur
DeviceAddress DS18b20_1 = { 0x28, 0x76, 0x29, 0x94, 0x97, 0x12, 0x03, 0x1F }; //Sonde 28 76 29 94 97 12 03 1D à changer !!
String sDS18b20_1;
...
//MQTT stuff including local broker/server IP address, login and pwd
MQTTClient MQTTClient;
const char* MqttServerIP = "192.168.1.91";
//const char* MqttServerIP = "broker.mqttdashboard.com";//cloud-based MQTT broker to test when node-red and MQTT broker are not installed locally (/!\ public and unsecure!)
